                        ...
                        <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="topbar-info">
                                            ...
                                            <span>/</span>
                                            <a href="mailto:support@example.com"><i
                                                    class="fa fa-envelope"></i>support@example.com</a>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                            ...
                            <div class="navbar-collapse hidden-sm hidden-xs">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle disabled"
                                            href="books-media-gird-view-v2.html">Books &amp; Media</a>
            ...
            <div data-ride="carousel" class="carousel slide" id="home-v1-header-carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <figure>
                            <img alt="Home Slide"
                                src="https://trello-backgrounds.s3.amazonaws.com/SharedBackground/2400x1600/f83251a75f09041fa31badbdf2cab8d4/photo-1604213410393-89f141bb96b8.jpg" />
                        </figure>
                        <div class="container">
                                ...
                                <ul>
                                    ...
                                    <li class="bg-red">
                                        <div class="fact-item">
                                            ...
                                            <span>Scientific <br>Articles<strong
                                                    class="fact-counter">14450</strong></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
